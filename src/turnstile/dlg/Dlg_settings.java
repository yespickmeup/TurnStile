...
import turnstile.backup.Dlg_backup;
import turnstile.faculty_and_staffs.Dlg_faculty_and_staffs;
import turnstile.reports.Dlg_report_access_logs;
import turnstile.students.Dlg_students;
import turnstile.users.Dlg_users;
...
//</editor-fold>
    ...
    private void initComponents() {
        ...
        jTabbedPane1.addTab("Faculty & Staff", jPanel4);
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/turnstile/img/remove11.png"))); // NOI18N
    ...
    private void myInit() {
        init_key();
        Dlg_import imp = new Dlg_import();
        jPanel2.setLayout(new BorderLayout());
        jPanel2.add(imp.getSurface());
        SwingUtilities.invokeLater(new Runnable() {
            @Override
            public void run() {

                Dlg_students student = new Dlg_students();
                jPanel3.setLayout(new BorderLayout());
                jPanel3.add(student.getSurface());

                Dlg_faculty_and_staffs faculty = new Dlg_faculty_and_staffs();
                jPanel4.setLayout(new BorderLayout());
                jPanel4.add(faculty.getSurface());

                Dlg_users user = new Dlg_users();
                jPanel5.setLayout(new BorderLayout());
                jPanel5.add(user.getSurface());

                Dlg_backup backup = new Dlg_backup();
