...
//</editor-fold>
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Login with your credentials!");
...
//                btn_0.doClick();
    ...
    private void login() {
        ...
        String where = " where username='" + user_name + "' and password='" + password + "' ";
        List<Users.to_users> users = Users.ret_data(where);
        
        if (users.size() > 0) {
            ok();
        } else {
            Alert.set(0, "Incorrect credentials");
