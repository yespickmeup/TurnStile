 ...
 * @author Guinness
 */
public class Dlg_faculty_and_staffs extends javax.swing.JDialog {

    /**
     * Creates new form Dlg_faculty_and_staffs
     */
...
//</editor-fold>
    ...
    private Dlg_faculty_and_staffs(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_faculty_and_staffs(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_faculty_and_staffs myRef;

    private void setThisRef(Dlg_faculty_and_staffs myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_faculty_and_staffs> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_faculty_and_staffs create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_faculty_and_staffs create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_faculty_and_staffs dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_faculty_and_staffs((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_faculty_and_staffs((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_faculty_and_staffs dialog = Dlg_faculty_and_staffs.create(new javax.swing.JFrame(), true);
...
//                btn_0.doClick();
    ...
    public void init_tbl_faculty_and_staffs(JTable tbl_faculty_and_staffs) {
        ...
        int[] tbl_widths_faculty_and_staffs = {0, 100, 150, 150, 150, 100, 30, 30, 30, 0, 0};
        ...
        tbl_faculty_and_staffs.getColumnModel().getColumn(6).setCellRenderer(new ImageRenderer1());
        tbl_faculty_and_staffs.getColumnModel().getColumn(7).setCellRenderer(new ImageRenderer1());

        TableColumn tc = tbl_faculty_and_staffs.getColumnModel().getColumn(8);
    ...
    public static class Tblfaculty_and_staffsModel extends AbstractTableAdapter {
        ...
        public static String[] COLUMNS = {
            "id", "ID No", "Last Name", "First Name", "Middle Name", "College", "", "", "", "created_at", "updated_at"
        };
    ...
    static class CheckBoxHeader extends JCheckBox
        ...
        public void mouseClicked(MouseEvent e) {
            ...
            List<to_faculty_and_staffs> datas = tbl_faculty_and_staffs_ALM;
            boolean selected = false;
            if (this.isSelected()) {
                selected = true;
            }
            for (to_faculty_and_staffs to : datas) {
    ...
    private void ret_faculty_and_staffs() {
        ...
        List<to_faculty_and_staffs> datas = Faculty_and_staffs.ret_data(where);
...
//</editor-fold> 
    ...
    private void save_faculty_and_staff() {
        ...
        if (row < 0) {
            ...
            to_faculty_and_staffs faculty = new to_faculty_and_staffs(id, id_no, fname, mname, lname, college, status, created_by, updated_by, created_at, updated_at, false);
            Faculty_and_staffs.add_data(faculty);
            Alert.set(1, "");
            ret_faculty_and_staffs();
            new_faculty_and_staff();
        } else {
            to_faculty_and_staffs faculty = (to_faculty_and_staffs) tbl_faculty_and_staffs_ALM.get(row);
            ...
            String lname = jTextField5.getText();
            String college = jTextField6.getText();
            int status = faculty.status;
            String created_by = faculty.created_by;
            String updated_by = "admin";
            String created_at = faculty.created_at;
            String updated_at = DateType.now();
            to_faculty_and_staffs faculty2 = new to_faculty_and_staffs(id, id_no, fname, mname, lname, college, status, created_by, updated_by, created_at, updated_at, false);
            Faculty_and_staffs.update_data(faculty2);
            Alert.set(2, "");
            ret_faculty_and_staffs();
            new_faculty_and_staff();
        }
    ...
    private void select_faculty_and_staff() {
        ...
        final to_faculty_and_staffs faculty = (to_faculty_and_staffs) tbl_faculty_and_staffs_ALM.get(row);
        if (col == 6) {
            ...
            jTextField6.setText(faculty.college);
        }
        if (col == 7) {
            ...
            nd.setCallback(new Dlg_confirm_action.Callback() {
                ...
                public void ok(CloseDialog closeDialog, Dlg_confirm_action.OutputData data) {
                    closeDialog.ok();
                    Faculty_and_staffs.delete_data(faculty);
                    Alert.set(3, "");
                    ret_faculty_and_staffs();
                    new_faculty_and_staff();
                }
    ...
    private void delete_selected_rows() {
        ...
        nd.setCallback(new Dlg_confirm_action.Callback() {
            ...
            public void ok(CloseDialog closeDialog, Dlg_confirm_action.OutputData data) {
                closeDialog.ok();
                List<to_faculty_and_staffs> datas = tbl_faculty_and_staffs_ALM;
                List<to_faculty_and_staffs> queue = new ArrayList();
                for (to_faculty_and_staffs to : datas) {
                    if (to.selected) {
                        queue.add(to);
                    }
                ...
                Faculty_and_staffs.delete_data(queue);
                Alert.set(3, "");
                ret_faculty_and_staffs();
                new_faculty_and_staff();
            }
